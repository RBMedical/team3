...
export default function Home() {
  ...
  React.useEffect(() => {
    appScriptRequest<{ ok: boolean; folderName?: string }>({ action: "getExportData" })
      .then(res => { if (res.ok && res.folderName) setDetailName(res.folderName); })
      .catch(() => {});
  }, []);
