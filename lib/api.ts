const APP_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbzVYpMvbpcNuHl9iovVItY0erg7F57-rErNtaKyuDjeUmO8eRf5XyHggwnj-Vdy-iQZ/exec";

// Global loading counter
let _loadingCount = 0;
function setGlobalLoading(active: boolean, message?: string) {
...
export function appScriptRequest<T = Record<string, unknown>>(
  ...
  return new Promise((resolve, reject) => {
    const showLoading = !!loadingMessage;
    if (showLoading) setGlobalLoading(true, loadingMessage);
